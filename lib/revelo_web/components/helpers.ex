defmodule ReveloWeb.ComponentHelpers do
  @moduledoc false
  ...
  @variants %{
    variant: %{
      ...
      "outline" =>
        "border-[length:var(--border-thickness)] border-input bg-background shadow-sm hover:bg-accent hover:text-accent-foreground",
