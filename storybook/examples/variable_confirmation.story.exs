    ...
    {:ok,
     assign(socket,
       ...
       variables: [
         ...
         %Variable{id: 7, name: "Samwise Gamgee", is_key?: false},
         %Variable{id: 8, name: "Gollum", is_key?: false},
         %Variable{id: 9, name: "Sauron", is_key?: false},
         %Variable{id: 10, name: "Saruman", is_key?: false},
         %Variable{id: 11, name: "Mordor", is_key?: false},
         %Variable{id: 12, name: "The Shire", is_key?: false},
         %Variable{id: 13, name: "Rohan", is_key?: false},
         %Variable{id: 14, name: "Gondor", is_key?: false},
         %Variable{id: 15, name: "Elrond", is_key?: false},
         %Variable{id: 16, name: "Galadriel", is_key?: false},
         %Variable{id: 17, name: "Faramir", is_key?: false},
         %Variable{id: 18, name: "Boromir", is_key?: false},
         %Variable{id: 19, name: "The Balrog", is_key?: false},
         %Variable{id: 20, name: "Ents", is_key?: false},
         %Variable{id: 21, name: "Rivendell", is_key?: false},
         %Variable{id: 22, name: "Isengard", is_key?: false},
         %Variable{id: 23, name: "The Ringwraiths", is_key?: false}
       ],
       votes: [
